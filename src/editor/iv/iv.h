...
#define VERSION			"0.39 (modified by Raman Gopalan)"
#define	ESC			0x1b
/*
 * raman: Changed the code for BKSP.
 * See term_translate(): common.c
 */
#define	BKSP			0x08
 ...
 * exit) in show_error();
 */
#define SHOW_ERROR_RET_VALUE	-1
#define RESTORE_INPUT_RET_VALUE 0
...
// A very simple structure for
// winsize (which you cannot find
// in the newlib headers).
