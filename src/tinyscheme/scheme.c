 ...
 *
 * Modified for Alcor6L, simplemachines-italy, Sept, 2013.
 */
...
int tinyscheme_main(int argc, char **argv) {
  ...
  // 'access()' gives me linker
  // problems. The file should be
  // readable on the Mizar32 even
  // without this.
